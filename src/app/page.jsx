...
export default function Home() {
  return (
    ...
    <main className="flex flex-col my-[8%] items-center justify-center p-4 lg:px-24">
      ...
      <Link href="./login"><button className="w-44 h-12 p-6 text-lg text-white font-bold bg-gradient-to-br gradient-radial from-blue-500 to-blue-900 rounded-lg flex items-center justify-center gap-2 "><TbLogin2 className="bold font-extrabold text-xl"/>Log In</button>
        </Link>
        <Link href="./signup"><button className="w-44 h-12 p-6 text-lg text-white font-bold bg-gradient-to-br gradient-radial from-[#09C090] to-[#09C09099] rounded-lg flex items-center justify-center gap-2 "><TbLogin2 className="bold font-extrabold text-xl"/>Sign Up</button>
        </Link></div>
